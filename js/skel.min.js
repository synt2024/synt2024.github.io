    ...
    var _ = {
        ...
        extend: function(e, t) {
            ...
            _.iterate(t, function(r) {
                typeof t[r] == n ? (typeof e[r] != n && (e[r] = {}),
                _.extend(e[r], t[r])) : e[r] = t[r]
            })
        },
        ...
        getDevicePixelRatio: function() {
            ...
            if (window[t] !== undefined && !r.match(/(Firefox; Mobile)/))
                return window[t];
            if (window[n]) {
                if (window[n]("(-webkit-min-device-pixel-ratio: 2),(min--moz-device-pixel-ratio: 2),(-o-min-device-pixel-ratio: 2/1),(min-resolution: 2dppx)").matches)
                    return 2;
                if (window[n]("(-webkit-min-device-pixel-ratio: 1.5),(min--moz-device-pixel-ratio: 1.5),(-o-min-device-pixel-ratio: 3/2),(min-resolution: 1.5dppx)").matches)
                    return 1.5
            }
            return 1
        },
        ...
        reverseRows: function(e) {
            ...
            _.iterate(n, function(r) {
                if (r === "length")
                    return;
                var i = n[r];
                if (i[t] || e > 0 && i.className.match(/\bno-collapse-([0-9])\b/) && parseInt(RegExp.$1) >= e)
                    return;
                var s = i.children, o;
                for (o = 1; o < s.length; o++)
                    i.insertBefore(s[o], s[0]);
                i[t] = !0
            })
        },
        bind: function(e, t) {
        ...
        changeState: function(e) {
            ...
            if (!_[i][r][_[n]]) {
                ...
                _[s].boxModel && (R = "iBM",
                (q = _[a](R)) || (q = _[f](R, _[l]("*,*:before,*:after{-moz-@;-webkit-@;@}".replace(/@/g, "box-sizing:" + _[s].boxModel + "-box")), c, 3)),
                F[p][h](q)),
                _[s].resetCSS ? (R = "iR",
                (q = _[a](R)) || (q = _[f](R, _[l](_.css.r), c, 2)),
                F[p][h](q)) : _[s].normalizeCSS && (R = "iN",
                ...
                F[p][h](q)),
                _[t].IEVersion >= 10 && (R = "mVIE" + _[n],
                (q = _[a](R)) || (q = _[f](R, _[l]("@-ms-viewport{width: device-width}"), c, 2)),
                F[p][h](q));
                var W, X;
                I = _[E](F[s][S]),
                W = I[0],
                ...
                _[o](B, function(e) {
                    _[u][B[e]][s].hasStyleSheet && _[s][d] && (R = "ss" + B[e],
                    (q = _[a](R)) || (q = _[f](R, _[v](_[s][d] + "-" + B[e] + m), c, 5)),
                    F[p][h](q)),
                    _[u][B[e]][p][A] > 0 && _[o](_[u][B[e]][p], function(t) {
                        F[p][h](_[u][B[e]][p][t])
                    })
                })
            } else
        ...
        newInline: function(e) {
            ...
            return _.vars.IEVersion <= 8 ? (n = document[t]("span"),
            n.innerHTML = '&nbsp;<style type="text/css">' + e + "</style>") : (n = document[t]("style"),
            n.type = "text/css",
            n.innerHTML = e),
            n
        },
        ...
        registerPlugin: function(e, t) {
            _.plugins[e] = t,
            t._ = this,
            _.isConfigured && (_.initPluginConfig(e, _.plugins[e]),
            t.init())
        },
        initPluginConfig: function(id, o) {
            var s, k = "_skel_" + id + "_config";
            window[k] ? s = window[k] : (s = document.getElementsByTagName("script"),
            s = s[s.length - 1].innerHTML.replace(/^\s+|\s+$/g, ""),
            s && (s = eval("(" + s + ")"))),
            typeof s == "object" && (s.preset && o.presets[s.preset] ? (_.extend(o.config, o.presets[s.preset]),
            _.extend(o.config, s)) : _.extend(o.config, s))
        },
        initConfig: function() {
            function buildTest(e, t) {
                ...
                : t.charAt(0) == n ? (fArgs[e] = parseInt(t.substring(1)),
                r = function(t) {
                    return t <= fArgs[e]
                }
                ) : t.charAt(t.length - 1) == n ? (fArgs[e] = parseInt(t.substring(0, t.length - 1)),
                r = function(t) {
                    return t >= fArgs[e]
                }
                ) : _.indexOf(t, n) != -1 ? (t = t.split(n),
            ...
            window._skel_config ? s = window._skel_config : (s = _.me.innerHTML.replace(/^\s+|\s+$/g, ""),
            s && (s = eval("(" + s + ")"))),
            function() {
                var e = "object"
                  , t = "preset"
        ...
        preInit: function() {
            var e = "getElementsByTagName"
              ...
              , r = document[e](t);
            _.me = r[r.length - 1],
            window._skel_config ? _[n] = !0 : (s = document[e](t),
            s = s[s.length - 1].innerHTML.replace(/^\s+|\s+$/g, ""),
            s && (_[n] = !0)),
            _[n] && _.init()
        }
