      ...
      , rn = {
        ...
        initElement: function(o) {
            ...
            case "panel":
                ...
                p[tn]("a")[h](H, gt)[Kt]("click.skel-panels", function(r) {
                    var i = jQuery(this);
                ...
                case Q:
                    ...
                    rn._[q][nt] ? p[h](B, "scroll")[h](ot, V)[h](R, "touch")[Kt](It, function(e) {
                ...
                case P:
                    ...
                    rn._[q][nt] ? p[h](B, "scroll")[h](ot, V)[h](R, "touch")[Kt](It, function(e) {
                        ...
                        if (a.swipeToClose && r < 20 && r > -20 && (a[s] == x && t > 50 || a[s] == P && t < -50))
                            return p[n](),
                            Z;
                        if (p[u]() == 0 && r < 0 || o > i - 2 && o < i + 2 && r > 0)
                            return Z
                    }) : p[h](B, mt);
                    switch (a.style) {
                    case xt:
        ...
        initElements: function(e) {
            ...
            rn._[lt](rn[v][e + "s"], function(n) {
                ...
                rn._[lt](i, function(s) {
                    ...
                    o.type = e,
                    o.onAttach = function() {
                        this[Lt] ? rn.resumeElement(this) : (rn.initElement(this),
                        this[Lt] = St)
                    }
                    ,
                    o.onDetach = function() {
        ...
        initJQueryUtilityFuncs: function() {
            ...
            jQuery.fn[ct] = function() {
                ...
                n > 0 && (e[tt](),
                e[h](c, (e.data(zt) + n) / 12 * 100 + "%"))
            }
            ;
            if (rn[v].useTransform && rn._[q].IEVersion >= 10 && (!rn[v][Tt] || rn._.hasActive(rn[v][Tt].split(","))))
                ...
                jQuery.fn[f] = function(t, i) {
                    ...
                    i = parseInt(i),
                    t != 0 ? (rn[e][Vt][h](rt, Mt),
                    rn[e][r][h](c, rn[e][C][c]())) : f = function() {
                        rn[e][Vt][h](rt, Nt),
                        rn[e][r][h](c, mt)
                    }
                    ,
        ...
        init: function() {
            ...
            if (rn._[q][A] == en && rn._[q].deviceVersion < 4 || rn._[q][A] == "wp")
                rn[v].useTransform = Z;
            rn.initObjects(),
